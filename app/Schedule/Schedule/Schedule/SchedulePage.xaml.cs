...
namespace Schedule
{
    ...
    public partial class SchedulePage : ContentPage
    {
                ...
                try
                {
                        ...
                        int.Parse(lesson.EndWeek) >= week)
                    {
                        if (int.Parse(lesson.WeekInterval) == 1 || (week - int.Parse(lesson.BeginWeek)) % 2 == 0)
                        {
                            ...
                            {
                                case 0:
                                    box.BackgroundColor = Color.AliceBlue;
                                    break;
                                case 1:
                                    box.BackgroundColor = Color.DarkSlateGray;
                                    break;
                                case 2:
                                    box.BackgroundColor = Color.LightGoldenrodYellow;
                                    break;
                                case 3:
                                    box.BackgroundColor = Color.Thistle;
                                    break;
        ...
        private void Picker_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                creatView(service.Lessons, picker.SelectedIndex + 1);
            }
            catch (Exception)
            {
